...
contract BlockNumber {
    ...
    function callMe() external {
        // Check if function was already called in this block
        require(block.number > lastBlockNumber, "Already called in this block");
        
        // Update lastCaller and lastBlockNumber
